$(document).ready(function () {
  ...
  var app = {
    ...
    cards: [
      { num: 1, image: 'img/clam.png' },
      { num: 1, image: 'img/clam.png' },
      { num: 2, image: 'img/glasses.png' },
      { num: 2, image: 'img/glasses.png' },
      { num: 3, image: 'img/pail.png' },
      { num: 3, image: 'img/pail.png' },
      { num: 4, image: 'img/rainbow.png' },
      { num: 4, image: 'img/rainbow.png' },
      { num: 5, image: 'img/sandals.png' },
      { num: 5, image: 'img/sandals.png' },
      { num: 6, image: 'img/shell.png' },
      { num: 6, image: 'img/shell.png' },
      { num: 7, image: 'img/shells.png' },
      { num: 7, image: 'img/shells.png' },
      { num: 8, image: 'img/snail.png' },
      { num: 8, image: 'img/snail.png' },
      { num: 9, image: 'img/snorkel.png' },
      { num: 9, image: 'img/snorkel.png' },
      { num: 10, image: 'img/starfish.png' },
      { num: 10, image: 'img/starfish.png' },
      { num: 11, image: 'img/sun.png' },
      { num: 11, image: 'img/sun.png' },
      { num: 12, image: 'img/tube.png' },
      { num: 12, image: 'img/tube.png' },
    ],
    // boolean for the players turn
    turn: true,
    //score
    scoreOne: 0,
    scoreTwo: 0,
    ...
    clickHandlers: function () {
      $('.card').on('click', function () {
        ...
        $(this)
          ...
          .addClass('selected')
          .css('background-image', `url(${$(this).data('cardImage')})`);
    ...
    checkWin: function () {
      ...
      if ($('.unmatched').length === 0) {
        // === to ensure that the value is 0 and not null
